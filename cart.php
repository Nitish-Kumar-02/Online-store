...
<div class="mainframe">
   <section class="shopping-cart">
      ...
      <form action="" method="POST" class="box">
         ...
         <img src="product_image/<?= $fetch_cart['image']; ?>" alt="" width="20" height="200">
      ...
      <div class="cart-total">
         ...
         <a href="checkout.php" id="checkout_btn" class="btn <?= ($grand_total > 1)?'':'disabled'; ?>">proceed to checkout</a>
      </div>
